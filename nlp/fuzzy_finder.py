...
from preprocessing.string_cleaning_utils import get_stopwords, get_punctuation, remove_stopstrings, remove_stopchars
...
class FuzzyFinder: 
    ...
    def __init__(self, features=CLINICAL_FEATURES_FILE):
        ...
        for elem in array:
            ...
            words = remove_stopchars(words, punctuation)
